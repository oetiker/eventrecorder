(function () {
	...
	qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qookery.internal.components.TableComponent", {
		...
		members: {
			...
			_createMainWidget: function _createMainWidget() {
				...
				switch (this.getAttribute("selection-mode", "single")) {
					case "none":
						selectionMode = qx.ui.table.selection.Model.NO_SELECTION;break;
					case "single":
						selectionMode = qx.ui.table.selection.Model.SINGLE_SELECTION;break;
					case "single-interval":
						selectionMode = qx.ui.table.selection.Model.SINGLE_INTERVAL_SELECTION;break;
					case "multiple-interval":
						selectionMode = qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION;break;
					case "multiple-interval-toggle":
						selectionMode = qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION_TOGGLE;break;
				}
			...
			_applyValid: function _applyValid() {
				// Overriden in order to prevent default handling
			},

			_applyRequired: function _applyRequired() {
				// Overriden in order to prevent default handling
...
//# sourceMappingURL=TableComponent.js.map?dt=1552484192489