(function () {
	...
	qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qookery.internal.FormParser", {
		...
		members: {
			...
			__parseStatementBlock: function __parseStatementBlock(blockElement, component) {
				...
				return qx.dom.Hierarchy.getChildElements(blockElement).reduce(function (previousResult, statementElement) {
					...
					if (component == null) throw new Error("Flow control and other non-component statements must appear with the context of a component");
					...
					if (component.parseXmlElement(elementName, statementElement)) return previousResult;
			...
			__parseComponent: function __parseComponent(componentElement, parentComponent, componentName, namespaces) {
				...
				try {
					...
					if (namespaces != null) component.setAttribute(qookery.IComponent.A_NAMESPACES, namespaces);
					...
					if (componentId != null && parentComponent != null) parentComponent.getForm().putComponent(componentId, component);
			...
			__parseScript: function __parseScript(scriptElement, component) {
				...
				if (sourceCode == null) throw new Error("Empty <script> element");
				...
				components.forEach(function (component) {
					...
					if (mediaQuery != null) {
						...
						if (!(execute && onlyOnce)) {
							...
							component.addToDisposeList({ dispose: function dispose() {
...
//# sourceMappingURL=FormParser.js.map?dt=1552484191428