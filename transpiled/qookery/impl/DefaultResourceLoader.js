(function () {
	...
	qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qookery.impl.DefaultResourceLoader", {
		...
		members: {
			...
			loadResource: function loadResource(name, thisArg, successCallback, failCallback) {
				...
				if (!successCallback) {
					successCallback = this._defaultSuccessCallback;asynchronous = false;
				}
				if (!failCallback) {
...
//# sourceMappingURL=DefaultResourceLoader.js.map?dt=1552484191168