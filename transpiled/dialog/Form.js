(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("dialog.Form", {
    ...
    members: {
      ...
      _applyFormData: function _applyFormData(formData, old) {
        ...
        var _loop = function _loop(_key) {
          ...
          formElement.setUserData("key", _key);
          var _this = _this2;
          if (typeof fieldData.type == "string") {
            switch (fieldData.type.toLowerCase()) {
              ...
              case "datefield":
              case "spinner":
                _this2._formController.addTarget(formElement, "value", _key, true, null, {
              ...
              case "checkbox":
                ...
                break;
              case "selectbox":
                _this2._formController.addTarget(formElement, "selection", _key, true, {
          ...
          if (qx.lang.Type.isObject(fieldData.events)) {
            for (var type in fieldData.events) {
              try {
                ...
                _this2.warn("Invalid '" + type + "' event handler for form element '" + _key + "'.");
              }
            }
          }
          ...
          _this2._form.add(formElement, label, validator);
          // Add the form elements as objects owned by the form widget
          formElement.setQxObjectId(_key);
...
//# sourceMappingURL=Form.js.map?dt=1552484220232