...
(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("dialog.Dialog", {
    ...
    statics: {
      ...
      select: function select(message, options, callback, context, allowCancel, caption) {
        var defaultOptions = [{ label: qx.core.Init.getApplication().tr("Yes"), value: true }, { label: qx.core.Init.getApplication().tr("No"), value: false }];
...
//# sourceMappingURL=Dialog.js.map?dt=1552484218597