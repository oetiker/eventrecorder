qx.$$packageData['0'] = {
  ...
  "resources": {
    "cboulanger/eventrecorder/ajax-loader.gif": [
      16,
      16,
      "gif",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/document-open.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/document-properties.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/document-save.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/emblem-symbolic-link.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/favicon.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/media-eject.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/media-playback-pause.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/media-playback-start.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/media-playback-stop.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/media-record.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/test.png": [
      32,
      32,
      "png",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/forms/editor.xml": [
      null,
      null,
      "xml",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/ace.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/ext-language_tools.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/mode-eventrecorder.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/mode-javascript.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/mode-json.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/mode-plain_text.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/theme-eclipse.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/worker-javascript.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ],
    "cboulanger/eventrecorder/js/ace/worker-json.js": [
      null,
      null,
      "js",
      "cboulanger.eventrecorder"
    ...
    "qx/icon/Tango/16/actions/address-book-new.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/bookmark-new.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/check-spelling.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/dialog-apply.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/document-new.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/document-open-recent.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/document-open.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/document-print-preview.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/document-print.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/document-properties.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/edit-copy.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/edit-cut.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/edit-paste.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/format-indent-less.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/format-indent-more.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/format-justify-left.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/format-justify-right.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/format-text-bold.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/format-text-direction-ltr.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/format-text-direction-rtl.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/go-first.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/go-previous.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/go-top.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/go-up.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/help-contents.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/insert-link.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/list-add.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/mail-mark-important.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/mail-mark-junk.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/mail-message-new.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/mail-reply-all.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/mail-reply-sender.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/mail-send.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/media-eject.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/media-playback-stop.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/media-skip-backward.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Tango/16/actions/window-new.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/zoom-fit-best.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/zoom-in.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/zoom-original.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Tango/16/actions/zoom-out.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qxl/widgetbrowser/fo_tester.swf": [
      null,
      null,
      "swf",
      "qxl.widgetbrowser"
    ],
    "qxl/widgetbrowser/loading66.gif": [
      66,
      66,
      "gif",
      "qxl.widgetbrowser"
  ...
  "translations": {
    ...
    "en": {
      ...
      "qookery.internal.validators.ArrayValidator.minimumLength": "Not enough elements in array, at least %1 are needed",
      "qookery.internal.validators.ArrayValidator.maximumLength": "Number of elements in array exceed maximum allowed of %1",
      "qookery.internal.validators.ComparisonValidator.eq": "Value must be equal to %1",
      "qookery.internal.validators.ComparisonValidator.ne": "Value must not be equal to %1",
      "qookery.internal.validators.ComparisonValidator.gt": "Value must be greater than %1",
      "qookery.internal.validators.ComparisonValidator.ge": "Value must be greater than or equal with %1",
      "qookery.internal.validators.ComparisonValidator.le": "Value must be less than or equal with %1",
      "qookery.internal.validators.ComparisonValidator.lt": "Value must be less than %1",
      "qookery.internal.validators.NotNullValidator.invalidMessage": "Required value is missing",
      "qookery.internal.validators.StringValidator.regularExpression": "Text does not match expected pattern",
      "qookery.internal.validators.StringValidator.minimumLength": "Text is not long enough, at least %1 characters are needed",
      "qookery.internal.validators.StringValidator.maximumLength": "Text is exceeds maximum length of %1",
      "qookery.internal.components.EditableComponent.componentError": "Field '%1'",
      "qookery.internal.components.FormComponent.validationErrors": "Error(s) encountered during form '%1' validation"
    }
  }
};
